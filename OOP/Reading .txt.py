class Song:
    ...
    Attributes:
        ...
        artist (str): The anme of the song's creator
        duration (int): The duration of the song in secionds. May be zero
        """
...
class Album:
    ...
    Methods:
        addSong: Used to add a new song to the album's tack list"""
...
class Artist:
    ...
    Attributes:
        ...
        albums (List[Album]): A list of the albums byu this artist.
    ...
    def add_album(self, album):
        ...
        Args:
            album (Album): Album obkect to add to the list.
    ...
    def add_song(self, name, year, title):
        ...
        A new album will be created in the collection if it doesn't already exit.

        Args:
                name (str): Tge name of the album
...
def create_checkfile(artist_list):
    """Create a check fuile from the obkect data for comparison with the original file"""
...
# Song.__init__.__doc__ = "Write docstring here"