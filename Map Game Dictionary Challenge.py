...
#checks every input by user to see if a direction is in there
# for that reason, if a user types "Go South", the program will see
#south and respond appropriately
    if len(direction) > 1:
